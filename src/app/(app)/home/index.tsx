          ...
          <View>
            ...
            <View className="flex-row justify-between items-center p-4 bg-white">
              ...
              <View>
                ...
                <Text className="text-2xl font-bold">{user?.firstName || 'Reader'}</Text>
              </View>
            </View>
            ...
            <View className="p-4">
              ...
              <View className="flex-row">
                <QuickActionButton
                  icon={<AntDesign name="plus" size={24} color={THEME_COLORS.primary} />}
                  label="Add Book"
                  onPress={() => router.push("/books/add")}
                />
                <QuickActionButton
                  icon={<Feather name="book-open" size={24} color={THEME_COLORS.primary} />}
                  label="My Books"
                  onPress={() => router.push("/books")}
                />
                <QuickActionButton
                  icon={<MaterialIcons name="category" size={24} color={THEME_COLORS.primary} />}
                  label="Categories"
            ...
            <View className="mx-4 p-4 bg-white rounded-xl shadow-sm">
              <Text className="text-lg font-semibold mb-3">Reading Progress</Text>
              <View className="flex-row justify-between items-center">
                <View className="items-center">
                  <Text className="text-2xl font-bold text-primary">{books?.length || 0}</Text>
            ...
            <View className="mx-4 mb-4 p-4 bg-white rounded-xl shadow-sm">
              ...
              <Text className="text-sm text-gray-600 mt-2">15 of 20 books read this year</Text>
            </View>
